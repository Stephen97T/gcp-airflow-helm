...
class TestMain(unittest.TestCase):
    ...
    def test_write_local_file(self, mock_file, mock_makedirs, mock_path_join):
        """
    ...
    def test_write_to_gcs(self, mock_storage_client):
        """
    ...
    def test_main(self, mock_write_to_gcs, mock_write_local_file):
        """
